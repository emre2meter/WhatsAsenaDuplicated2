...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({pattern: 'alive', fromMe: true, dontAddCommandList: true, desc: Lang.ALIVE_DESC}, (async (message, match) => {
        ...
        if (Config.ALIVEMSG == 'default') {
            ...
            await message.client.sendMessage(message.jid, fs.readFileSync("/root/WhatsAsenaDuplicated/media/gif/Yaşasın ırkımız dans eden kurt cCc auuuuuu auuu(360P).mp4"),MessageType.video, { mimetype: Mimetype.mp4, caption: '```WhatsAsena Founder İçin Çalışıyor```\n\n```Version:``` *v31.0*\n```Branch:``` *Owner*\n\n\n' + Config.ALIVEMSG});
        }
    }));
